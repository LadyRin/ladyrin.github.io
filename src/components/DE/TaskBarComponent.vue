...
const emit = defineEmits(['open-app', 'close-app', 'maximize', 'minimize'])
...
onMounted(() => {
  document.addEventListener('click', (e) => {
    if (
      e.target != document.querySelector('.startButton') &&
...
<template>
  <div class="taskBar">
    ...
    <div class="startMenu" :class="{ active: menuOpen }">
      ...
      <div
        v-for="app in appsInStartMenu"
        class="startMenuItem"
        @click="openApp(app.app)"
        :key="app.name">
