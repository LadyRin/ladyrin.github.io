...
<template>
  <div class="container">
    <nav>
      <ul>
        <li>
          <span @click="openPage('?path=/home/user/Desktop/À propos.html')"> À propos </span>
        </li>
        <li>
          <span @click="openPage('?path=/home/user/Documents/Projets.html')"> Projets </span>
        </li>
        <li>
          <span @click="openPage('?path=/home/user/Documents/Contact.html')"> Contact </span>
        </li>
        <li>
